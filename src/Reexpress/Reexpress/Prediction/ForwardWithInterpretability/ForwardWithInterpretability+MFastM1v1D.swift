//
//  ForwardWithInterpretability+MFastM1v1D.swift
//  Alpha1
//
...
extension MainForwardAfterTrainingView {
    ...
    func forward_MFastM1v1D(batchSize: Int, datasetId: Int) async throws {
