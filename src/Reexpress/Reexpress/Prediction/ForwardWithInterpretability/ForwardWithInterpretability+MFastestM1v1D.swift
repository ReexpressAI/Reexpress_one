//
//  ForwardWithInterpretability+MFastestM1v1D.swift
//  Alpha1
//
...
extension MainForwardAfterTrainingView {
    ...
    func forward_MFastestM1v1D(batchSize: Int, datasetId: Int) async throws {
