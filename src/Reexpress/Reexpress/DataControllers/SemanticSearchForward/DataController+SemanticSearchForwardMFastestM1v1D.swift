//
//  DataController+SemanticSearchForwardMFastestM1v1D.swift
//  Alpha1
//
...
extension DataController {
    ...
    func semanticSearch_forward_MFastestM1v1D_singleInstance(documentSelectionState: DocumentSelectionState) async throws -> [Float32] {
