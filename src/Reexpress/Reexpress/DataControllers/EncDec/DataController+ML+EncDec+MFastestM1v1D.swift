//
//  DataController+ML+EncDec+MFastestM1v1D.swift
//  Alpha1
//
...
extension DataController {
    ...
    func forwardPassEncDecSimpleBatchDual_MFastestM1v1D(model: MFastestM1v1D, reduceModel: MFastestM1v1DReduce, batchSize: Int, tokenizedInputDic: [Int: SentencepieceTokenizer.DocumentTokenizationResult], multiTokenizedInputDic: [Int: SentencepieceTokenizer.DocumentTokenizationResult], padId: TokenIdType, multiPadId: TokenIdType) async throws -> [Int: [Float32]] {
        ...
        for batchIndex in 0..<batchGroupToModelOutputArray.count {
            ...
            try forwardDualReduceEncoderHiddenStates_MFastestM1v1D(modelOutput: modelOutput, batchedInputs: batchedInputs, sentencesInGroup: sentencesInGroup, reduceModel: reduceModel, sentenceIndexToEmbeddings: &sentenceIndexToEmbeddings)
        }
    ...
    func forwardDualReduceEncoderHiddenStates_MFastestM1v1D(modelOutput: [MFastestM1v1DOutput], batchedInputs: [MFastestM1v1DInput], sentencesInGroup: [Int], reduceModel: MFastestM1v1DReduce, sentenceIndexToEmbeddings: inout [Int: [Float32]]) throws {
