//
//  DataController+ML+EncDec+MFastM1v1D.swift
//  Alpha1
//
...
extension DataController {
    ...
    func forwardPassEncDecSimpleBatchDual_MFastM1v1D(model: MFastM1v1D, reduceModel: MFastM1v1DReduce, batchSize: Int, tokenizedInputDic: [Int: SentencepieceTokenizer.DocumentTokenizationResult], multiTokenizedInputDic: [Int: SentencepieceTokenizer.DocumentTokenizationResult], padId: TokenIdType, multiPadId: TokenIdType) async throws -> [Int: [Float32]] {
        ...
        for batchIndex in 0..<batchGroupToModelOutputArray.count {
            ...
            try forwardDualReduceEncoderHiddenStates_MFastM1v1D(modelOutput: modelOutput, batchedInputs: batchedInputs, sentencesInGroup: sentencesInGroup, reduceModel: reduceModel, sentenceIndexToEmbeddings: &sentenceIndexToEmbeddings)
        }
    ...
    func forwardDualReduceEncoderHiddenStates_MFastM1v1D(modelOutput: [MFastM1v1DOutput], batchedInputs: [MFastM1v1DInput], sentencesInGroup: [Int], reduceModel: MFastM1v1DReduce, sentenceIndexToEmbeddings: inout [Int: [Float32]]) throws {
